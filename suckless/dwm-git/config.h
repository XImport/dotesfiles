...
static const char *fonts[]          = { "monospace:size=10","Mononoki Nerd Font:size=14" };
static const char dmenufont[]       = "monospace:size=10";
static const char col_gray1[]       = "#282a36";
static const char selected[]        = "#282a36";
static const char unselected[]      = "#282a36";
...
static const char *colors[][3]      = {
	...
	[SchemeStatus]  = { col_gray4,  selected,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_gray4, col_gray2,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
    [SchemeTagsNorm]  = { "#000000", selected,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
    [SchemeInfoSel]  = { col_gray4,  selected ,"#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
    [SchemeInfoNorm]  = { col_gray3, unselected,  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
};
static const unsigned int alphas[][3]      = {
	/*               fg      bg        border     */
    [SchemeNorm] = { 255,  50,   255   },
    [SchemeSel]  = { 255,  80, 255   },
    [SchemeStatus]  = { 255,  100, 255   },
    [SchemeTagsSel]  = { 255,  80, 255   },
    [SchemeTagsNorm]  = { 255,  90, 255   },
    [SchemeInfoSel]  = { 255,  100, 255   },
